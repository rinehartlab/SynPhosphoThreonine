...
do
	...
	cd ../output/aligned_${SAMPLENAME}/qual_${qual}
        bwa mem -t 8 -M ../../../code/library_fasta/180825_Phosphorylation_site_dataset_pThronly_TAG_final.fasta ../../../temp/merged_reads/merged_${SAMPLENAME}/qual_${qual}/${SAMPLENAME}_bbmerge_trim.fastq > aligned.sam
